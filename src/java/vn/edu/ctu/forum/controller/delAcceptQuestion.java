 ...
 */
@WebServlet(name = "delAcceptQuestion", urlPatterns = {"/delAcceptQuestion"})
public class delAcceptQuestion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.sendRedirect("acceptquestion.jsp");
